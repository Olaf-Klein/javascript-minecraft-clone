...
use minecraft_clone_rust::net::protocol::{ClientMessage, PlayerSnapshot, ServerMessage};

#[tokio::main]
async fn main() -> Result<(), Box<dyn Error>> {
    let addr = std::env::var("SERVER_ADDR").unwrap_or_else(|_| "0.0.0.0:25565".to_string());
    println!("Starting multiplayer server on {}", addr);
